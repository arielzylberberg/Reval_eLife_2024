function [err,P] = wrapper_dtb_parametricbound_rt_plaw_leak(theta,rt,coh,choice,c,pars,plot_flag)
...
switch methodforward_flag
    case 1 % chang cooper
        ...
        P = dtb_fp_cc_vec_leak(drift,t,Bup,Blo,y,y0,notabs_flag,'leak',leak_time_constant);
%     case 2 % fft
...
%%
%% print
fprintf('err=%.3f kappa=%.2f ndt_mu=%.2f ndt_s=%.2f B0=%.2f a=%.2f d=%.2f coh0=%.2f y0=%.2f plaw=%.2f leak=%.2f \n',...
    err,kappa,ndt_m,ndt_s,B0,a,d,coh0,y0a,plaw,leak_time_constant);
